...
def set_credentials(username, api_key=None, password=None, region=None,
    ...
    If the region is passed, it authenticates against the proper endpoint
...
def authenticate():
    ...
    credentials via set_credentials() and set_credential_file() calls
    ...
    the authentication sequence, this method calls the identity object's
    authenticate() method, and an AuthenticationFailed exception is raised
