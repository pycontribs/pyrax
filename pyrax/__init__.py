...
def connect_to_cloudfiles(region=None, public=True):
    ...
    opts = {"tenant_id": identity.tenant_name, "auth_token": identity.token,
            ...
            "region_name": region}
    cloudfiles = _cf.CFClient(identity.auth_endpoint,
                              identity.username,
                              identity.api_key,
...
def connect_to_cloud_databases(region=None):
    ...
    cloud_databases = CloudDatabaseClient(identity.username,
                                          identity.api_key,
                                          region_name=region,
                                          management_url=ep,
...
def connect_to_cloud_loadbalancers(region=None):
    ...
    _service_type = "rax:load-balancer"
...
def connect_to_cloud_dns(region=None):
    ...
    cloud_dns = CloudDNSClient(identity.username,
                               identity.api_key,
                               region_name=region,
                               management_url=ep,
                               auth_token=identity.token,
...
def connect_to_cloud_networks(region=None):
    ...
    cloud_networks = CloudNetworkClient(identity.username,
                                        identity.api_key,
                                        region_name=region,
                                        management_url=ep,
                                        auth_token=identity.token,
