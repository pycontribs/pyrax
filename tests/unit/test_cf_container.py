...
class CF_ContainerTest(unittest.TestCase):
    ...
    def test_store_object(self):
        ...
        cont.store_object(
            self.obj_name, content, content_type="test/test", etag=etag)
    ...
    def test_set_metadata(self):
        ...
        cont.client.connection.post_container.assert_called_with(
            cont.name, {"x-container-meta-newkey": "newval"})
    ...
    def test_set_web_index_page(self):
        ...
        cont.client.connection.post_container.assert_called_with(
            cont.name, {"x-container-meta-web-index": page})
    ...
    def test_set_web_error_page(self):
        ...
        cont.client.connection.post_container.assert_called_with(
            cont.name, {"x-container-meta-web-error": page})
