...
**region** | Regional datacenter to connect to; either 'DFW', 'ORD', 'IAD', or 'LON' for Rackspace; typically 'RegionOne' in Keystone. | IAD | This must be specified for all non-Rackspace environments. | CLOUD_REGION
